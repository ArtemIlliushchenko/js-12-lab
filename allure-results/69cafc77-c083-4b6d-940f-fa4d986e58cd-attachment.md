...
- Name: lab12.spec.js >> Лабораторна робота 12 - Базовий рівень >> Завдання 2: Логін з неправильним паролем
- Location: tests\lab12.spec.js:22:9
...
Call log:
  ...
  - waiting for locator('#flash')
    14 × locator resolved to <div id="flash" data-alert="" class="flash error">…</div>
       - unexpected value "
            Your password is invalid!
            ×
          "
